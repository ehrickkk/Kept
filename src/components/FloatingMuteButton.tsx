...
export function FloatingMuteButton() {
  ...
  return (
    <button
      ...
      aria-pressed={muted}
      className={`glass-panel fixed z-40 flex h-11 w-11 items-center justify-center rounded-full transition-colors duration-300 ease-out lg:hidden bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-[max(1rem,env(safe-area-inset-left))] ${
        muted
